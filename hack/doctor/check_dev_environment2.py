...
#         # Required environment variables with expected values
#         env_vars = {
...
#                     self.print_success(f"{var_name} = {result['current_value']}")
#                     correct_count += 1
#                 else:
#                     self.print_warning(f"{var_name} = {result['current_value']} (expected: {expected_value})")
#             else:
#                 self.print_failure(f"{var_name} - NOT SET (expected: {expected_value})")

#         print(f"\n{Colors.BOLD}Summary:{Colors.ENDC} {set_count}/{len(env_vars)} variables set")
#         print(f"{Colors.BOLD}Correct values:{Colors.ENDC} {correct_count}/{len(env_vars)}")

#         # Provide export commands for missing/incorrect variables
#         if correct_count < len(env_vars):
#             print(f"\n{Colors.YELLOW}To set missing/incorrect variables, add to your ~/.zshrc or ~/.bashrc:{Colors.ENDC}")
#             print()
...
#                     else:
#                         print(f'export {result["var_name"]}={expected}')
#             print(f"\n{Colors.YELLOW}Or set them temporarily in your current shell:{Colors.ENDC}")
#             print()
#             for result in self.results['env_vars']:
#                 if not result['value_correct']:
#                     expected = result['expected_value']
